...
module.exports = async function organiseMaintainers() {
  ...
  const maintainerArray = res.data.content.reduce((maintainers, currentPackage) => {
    currentPackage.package.maintainers.forEach((maintainerObject) => {
      ...
      // If we have, we need to add the packagename to the existing entry (and sort it) instead of making a new one
